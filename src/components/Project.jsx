...
export default function Project({ onSave ,onCancel}) {
  const modal = useRef();
  const title = useRef();
    ...
    <>
      ...
      <div className="w-[35rem] mt-16">
        <menu className="flex items-center justify-end gap-4 my-4">
          <li>
            <button className=" px-6 py-2 rounded-md text-stone-500 hover:text-stone-950 bg-stone-300" onClick={onCancel}>
              Cancel
            </button>
          </li>
          <li>
